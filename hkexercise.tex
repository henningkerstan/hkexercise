...
% obtain package version using xstring package to obtain 15 leftmost characters in the internal package version string
\makeatletter
\usepackage{xstring}
\newcommand{\packageversion}{\StrLeft{\expandafter\csname ver@hkexercise.sty\endcsname}{15}}
\makeatother
...
\begin{description}
\item[2017/06/26 v1.1-alpha??] Redefined \textcolor{NavyBlue}{\ttfamily\bfseries\textbackslash currentexercisepoints} now allows it to be used within section command. 
